...
class BikeTestCase(TestCase):
    ...
    def test_retrieve_bike(self):
        ...
        response = self.client.get(reverse('bikes:bicycles-detail', kwargs={'pk': self.bike1.pk}))
    ...
    def test_update_bike(self):
        ...
        response = self.client.patch(reverse('bikes:bicycles-detail', kwargs={'pk': self.bike1.pk}), new_data)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_destroy_bike(self):
        ...
        response = self.client.delete(reverse('bikes:bicycles-detail', kwargs={'pk': self.bike1.pk}))
...
class BikePermsTestCase(TestCase):
    ...
    def test_update_nonmoderator(self):
        ...
        response = self.client.put(reverse('bikes:bicycles-detail', kwargs={'pk': self.bike1.pk}), {})
        self.assertEqual(response.status_code, status.HTTP_403_FORBIDDEN)
